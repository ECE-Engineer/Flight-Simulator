...
###DISPLAY THROUGHPUT
layout1 = go.Layout(
	title=('Throughput' + ' Ran On Rho' + ' With 32 Threads'),
	xaxis=dict(
		tickangle=-15
	),
	yaxis=dict(
...
layout2 = go.Layout(
	title=('Average Time' + ' Ran On Rho' + ' With 32 Threads'),
	xaxis=dict(
		tickangle=-15
	),
	yaxis=dict(
...
###DISPLAY SINGLE SHOT
layout3 = go.Layout(
	title=('Single Shot' + ' Ran On Rho' + ' With 32 Threads'),
	xaxis=dict(
		tickangle=-15
	),
	yaxis=dict(
...
###DISPLAY THROUGHPUT
layout1 = go.Layout(
	title=('Throughput' + ' Ran On Rho' + ' With 16 Threads'),
	xaxis=dict(
		tickangle=-15
	),
	yaxis=dict(
...
###DISPLAY AVERAGE TIME
layout2 = go.Layout(
	title=('Average Time' + ' Ran On Rho' + ' With 16 Threads'),
	xaxis=dict(
		tickangle=-15
	),
	yaxis=dict(
...
###DISPLAY SINGLE SHOT
layout3 = go.Layout(
	title=('Single Shot' + ' Ran On Rho' + ' With 16 Threads'),
	xaxis=dict(
		tickangle=-15
	),
	yaxis=dict(
